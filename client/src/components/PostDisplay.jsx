  ...
  return (
    <div className='group relative w-full border border-red-400 hover:border-2 h-[400px] overflow-hidden rounded-lg sm:w-[430px] transition-all'>
        ...
        <div className='p-3 flex flex-col gap-2 '>
            ...
            <Link to={`/post/${post.slug}`} className='z-10 group-hover:bottom-0 absolute bottom-[-200px] left-0 right-0 border border-red-400 text-red-400 hover:bg-red-400 hover:text-white transition-all duration-300 text-center py-2 rounded-md m-2 '>
            Read More
            </Link>
        </div>
    </div>
